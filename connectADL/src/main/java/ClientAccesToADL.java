...
public class ClientAccesToADL {
  
  
  // This needs to be filled in for the app to work
  private static String accountFQDN = "lala";  // full account FQDN, not just the account name
  private static String clientId = "lala";
  private static String authTokenEndpoint = "lala";
  private static String clientKey = "lala";
